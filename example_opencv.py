...
# Elegir camara y ajustar tamaño de la imagen
...
# Funcion necesaria para pasarsela como parámetro a los trackbars (No hace nada)
def empty(a):
    pass

# Creacion de ventan con trackbars para poder ajustar el color "tarjet"
cv2.namedWindow("HSV")
...
# Funcion para agrupar imagenes y poder mostrarlas juntas
...
# Funcion que recibe una imagen (img) y devuelve imgContour con la deteccion pintada sobre la imagen 
...
# Funcion que pinta sobre la imagen recibida un cuadrante
def display(img):
...
while True:
    ...
    # Si se pulsa la letra q se sale del bucle de reconocimiento
    if cv2.waitKey(1) & 0xFF == ord('q'):
        break

# Cierra la camara y destruye las ventanas creadas
cap.release()
